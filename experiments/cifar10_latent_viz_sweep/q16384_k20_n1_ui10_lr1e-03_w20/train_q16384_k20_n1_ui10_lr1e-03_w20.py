"""CIFAR10 SimCLR training with LatentViz - Experiment q16384_k20_n1_ui10_lr1e-03_w20."""
...
latent_viz = LatentViz(
    ...
    plot_interval=10,
    save_dir="experiments/cifar10_latent_viz_sweep/q16384_k20_n1_ui10_lr1e-03_w20/latent_viz",
    input_dim=512,
)
...
wandb_logger = WandbLogger(
    ...
    name="cifar10_q16384_k20_n1_ui10_lr1e-03_w20",
    log_model=False,
    config={'queue_length': 16384, 'k_neighbors': 20, 'n_negatives': 1, 'update_interval': 10, 'lr': 0.001, 'warmup_epochs': 20, 'exp_id': 'q16384_k20_n1_ui10_lr1e-03_w20'},
)

csv_logger = CSVLogger(
    save_dir="experiments/cifar10_latent_viz_sweep/q16384_k20_n1_ui10_lr1e-03_w20",
    name="metrics"
)
